...
def main():
    ...
    ax2.plot(a, R0s, c="black", linewidth=2, label="R0")
    ax2.legend()

    plt.title("s= {}".format(s))

    # saving and showing figure
    plt.savefig("outputs/superinfection/superinfection with {} strains, {:e} points and s={}.png".format(
